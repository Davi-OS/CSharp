...
class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        FilaJogadores.preencheFila(time, n);

        //exibindo os Jogadores na Fila
...
class Fila
{
    ...
    //Jogadores temporarios necessarios para realizar as operações de  Remoçãoo e inserção na Fila
    ...
    public void preencheFila(Jogadores[] jogadoresIniciais, int qnt)
    {
        primeiro = new Celula();
        ultimo = primeiro;
